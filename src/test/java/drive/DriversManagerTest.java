...
import com.generation.drive.Driver;
import com.generation.drive.DriversManager;
import com.generation.drive.Passenger;
...
public class DriversManagerTest {
    ...
    public void passengerAdded() {
        Passenger passenger = new Passenger("Giovanni", "123456");
    ...
    public void driverAdded() {
        Driver driver = new Driver("Julio", "789645","428p");
